...
export default class PortfolioCarousel extends component(Object3D) {
    ...
    setupSlides(projects) {
        ...
        for (let i = 0; i < projects.length; i++) {
            ...
            const texture = new Texture(ResourceLoader.get(project.slug));
    ...
    _createDebugGui(gui) {
        ...
        const folder = gui.addFolder('Portfolio carousel');
        return folder;
    }
}
