...
import { AdditiveBlending, LinearFilter, RGBAFormat, ShaderMaterial, UniformsUtils, WebGLMultisampleRenderTarget, WebGLRenderTarget } from 'three';
...
SSAARenderPass.prototype = Object.assign(Object.create(Pass.prototype), {
    ...
    render: function (renderer, writeBuffer, readBuffer) {
        if (!this.sampleRenderTarget) {
            // this.sampleRenderTarget = new WebGLMultisampleRenderTarget(readBuffer.width, readBuffer.height, { minFilter: LinearFilter, magFilter: LinearFilter, format: RGBAFormat });
