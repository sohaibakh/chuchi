...
export default {
  ...
  methods: {
    ...
    backgroundShow(done, direction) {
      ...
      // Simple fade-in
      this.timelineShow.set(this.$el, { alpha: 0 });
      this.timelineShow.to(this.$el, 1.5, { alpha: 1, ease: 'power2.out' }, 0);
    ...
    backgroundHide(done, direction) {
      ...
      this.timelineHide = new gsap.timeline({ onComplete: done });
      this.timelineHide.to(this.$el, 1, { alpha: 0, ease: 'power2.inOut' });
