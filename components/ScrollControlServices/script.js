...
export default {
    ...
    methods: {
        ...
        nextStep() {
            if (this.$store.state.aboutScrollLock) return;
        ...
        hideSection(index, direction, done) {
            ...
            if (typeof component.backgroundHide === 'function') {
                component.backgroundHide(direction);
                done();
            } else {
                done();
            }
        ...
        resetBackgroundPosition() {
            ...
            // this.$root.webglBackground.$el.style.opacity = 1;
        ...
        updateWebglBackgroundPosition(y) {
            ...
            this.$root.webglBackground.$el.style.opacity = 1 - canvasY * 0.003;
            this.$root.webglApp.getScene('services')._container.position.y = canvasY * 0.003;
        },
